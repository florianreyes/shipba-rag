...
export function SearchComponent() {
  ...
  // Si no hay workspace seleccionado, no renderizar este componente completo
  if (!selectedWorkspace) {
    return null;
  }
  ...
  return (
    <div className="w-full mb-24">
      ...
      >
        <motion.h1 
          className="text-3xl font-bold mb-8 font-mono mt-8"
        ...
        <form onSubmit={handleSearch} className="w-full max-w-xl">
          ...
          >
            <Input
              placeholder={`¿Qué tipo de personas buscas?`}
              value={input}
            ...
            {lastQuery && persons.length > 0 && (
              ...
              >
                <p className="text-lg font-medium">
                  Búsqueda en {selectedWorkspace.name}: 
